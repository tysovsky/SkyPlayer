...
public class MusicIntentReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        if (intent.getAction().equals(android.media.AudioManager.ACTION_AUDIO_BECOMING_NOISY)) {
            ...
            context.startService(Utilities.convertImplicitIntentToExplicitIntent(new Intent(MusicService.ACTION_PAUSE), context));
            ...
            switch (keyEvent.getKeyCode()) {
                ...
                case KeyEvent.KEYCODE_MEDIA_NEXT:
                    context.startService(new Intent(MusicService.ACTION_RESUME));
                    break;
                case KeyEvent.KEYCODE_MEDIA_PREVIOUS:
                    // TODO: ensure that doing this in rapid succession actually plays the
                    // previous song
                    context.startService(new Intent(MusicService.ACTION_REWIND_TO));
                    break;
            }
        }
    }
